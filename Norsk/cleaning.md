...
### Før bruk
Før du bruker Duofiller bør du sikre at slangene er rene før drikken introduseres. Vi anbefaler følgende rengjøringsprosedyre:

1. Skyll gjennom boksfylleren med lunkent vann. Start en fylling i Timermodus-programmeringsmodus for skylling — fylleventilen står da åpen til den manuelt avbrytes. Kontakttid 5 minutter eller mer. Hvis det er førstegangs bruk eller det er væskerester i slangene, anbefaler vi PBW eller oppvaskmiddel (i anbefalt konsentrasjon) og 10 minutters skylling.
...
6. Fjern alltid trykket fra fylleslangen og CO~2~-slangen, og koble fra strømmen etter bruk.
