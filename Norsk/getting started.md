...
- Bruk alltid dryppbrett for å samle opp søl under Duofiller.
- Pass på at Duofiller er koblet til et fat med kaldt vann, og at fattrykket er ca. 1 bar.
- Koble til CO~2~ til purge og sørg for at CO~2~-trykket er under 3 psi / 0,2 bar.
- Slå på Duofiller ved å koble strømforsyningen til stikkontakten.

Når den starter opp første gang vil kanppen lyse grønt. Det indikerer at den er i Timermodus. Ved førstegangs bruk bør den være i Sensormodus for kalibrering og funksjonstest. Hold inne knappen i 2 sekunder og slipp. Lampen skal skifte til konstant blå, som indikerer at den er i Sensormodus. (Hvis lampen i stedet begynner å blinke grønt, har du sannsynligvis holdt knappen for lenge. Hold knappen i 4–5 sekunder og slipp så bør den være tilbake i Timermodus; forsøk så å sette den i Sensormodus igjen.)
...
Gå tilbake til Timermodus (hold inne knappen i 2 sekunder og slipp). Når du er i Timermodus, hold knappen inne i 4–5 sekunder og slipp for å gå til programmering av fyllenivå i Timermodus. Knappen begynner å blinke grønt, som indikerer at programmering av fyllenivå i Timermodus er aktiv. Bruk et glass, en boks eller en flaske til programmeringen. Programmeringen gjøres på nøyaktig samme måte som i Sensormodus. Start en fylling og stopp den ved ønsket fyllenivå. Den eneste forskjellen er at boksfylleren ved vellykket lagring ikke automatisk går tilbake til Timermodus. For å gå tilbake til Timermodus, hold inne trykknappen i 4–5 sekunder og slipp.
...
## Fylling med drikke
Etter førstegangs rengjøring er boksfylleren klar til bruk. Koble til et fat. Gjenta kalibreringen av fyllenivået. Forvent ikke at fyllenivået programmert med vann blir helt identisk det faktiske fyllenivået med innholdet i fatet. Mange faktorer spiller inn: i Sensormodus påvirkes fyllenivået av SG, karboneringsnivå (mengden bobler) og flow. I Timermodus påvirkes fyllenivået hovedsakelig av fattrykk og viskositet. Med stabilt fattrykk vil Timermodus være den mest nøyaktige modusen. Hvis du opplever inkonsekvent nivå i Timermodus, bytt til Sensormodus.
...
**Slå av boksfylleren, trykk inn knappen og slå på mens du holder knappen inne:**

Hold knappen inne i 5 sekunder og slipp for å nullstille nettverksinnstillingene. 5 sekunder indikeres med blå LED.

Hold knappen inne i 10 sekunder og slipp for å nullstille alle innstillinger til fabrikktilstand. 10 sekunder indikeres med rød LED.
